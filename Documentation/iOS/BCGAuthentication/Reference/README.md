...
-   [AuthenticationConfiguration](protocols/AuthenticationConfiguration.md)
-   [BCGAuthAnalyticsSinkProvider](protocols/BCGAuthAnalyticsSinkProvider.md)
-   [BCGLoginViewControllerDelegate](protocols/BCGLoginViewControllerDelegate.md)
-   [UIConfigurator](protocols/UIConfigurator.md)
...
-   [UserObject](structs/UserObject.md)
