...
-   [EmployeePhotoService](protocols/EmployeePhotoService.md)
-   [EventEmployeeSelection](protocols/EventEmployeeSelection.md)
-   [EventFeature](protocols/EventFeature.md)
-   [EventsAnalytics](protocols/EventsAnalytics.md)
-   [EventsReachability](protocols/EventsReachability.md)
...
-   [AddAttendeeOptionsModel](structs/AddAttendeeOptionsModel.md)
-   [ApproveAttendeeResult](structs/ApproveAttendeeResult.md)
-   [CreateEventResult](structs/CreateEventResult.md)
...
-   [EventFilterResponse](structs/EventFilterResponse.md)
-   [EventFilterResults](structs/EventFilterResults.md)
-   [EventGroupsResult](structs/EventGroupsResult.md)
-   [EventResults](structs/EventResults.md)
-   [EventsConfigurationsData](structs/EventsConfigurationsData.md)
-   [FetchEventResults](structs/FetchEventResults.md)
-   [PoolOfficeModel](structs/PoolOfficeModel.md)
-   [RequestSeatResult](structs/RequestSeatResult.md)
-   [UpdateAttendeeInfoResult](structs/UpdateAttendeeInfoResult.md)
-   [UpdateEventResult](structs/UpdateEventResult.md)
...
-   [PoolOffice](classes/PoolOffice.md)
...
-   [AttendingType](enums/AttendingType.md)
